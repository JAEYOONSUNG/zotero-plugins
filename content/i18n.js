...
var ZotPoPI18N = (function () {
	...
	const STRINGS = {
		en: {
			...
			csvHead: ["Cites", "CitesPerYear", "Rank", "Authors", "Title", "Year", "Publication", "Publisher", "DOI", "URL", "PDF", "Source", "InLibrary"],
			csvYes: "yes",
			csvNo: "no",
		...
		ko: {
			...
			csvHead: ["인용", "연간인용", "순위", "저자", "제목", "연도", "저널", "출판사", "DOI", "URL", "PDF", "소스", "보유"],
			csvYes: "예",
			csvNo: "아니오",
