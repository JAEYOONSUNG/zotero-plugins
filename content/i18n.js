...
var ZotPoPI18N = (function () {
	...
	const STRINGS = {
		en: {
			...
			prefOpenAlexNote: "Without a key OpenAlex allows roughly ten searches per day and then refuses every request until midnight UTC. A free key at openalex.org raises the allowance about a hundredfold. Crossref, Europe PMC, PubMed and arXiv need no key.",
		...
		ko: {
			...
			prefOpenAlexNote: "키가 없으면 OpenAlex는 하루 약 10회 검색 후 자정(UTC)까지 모든 요청을 거부합니다. openalex.org에서 무료 키를 받으면 한도가 약 100배가 됩니다. Crossref·Europe PMC·PubMed·arXiv는 키가 필요 없습니다.",
